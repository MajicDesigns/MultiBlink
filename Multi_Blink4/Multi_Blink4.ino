...
{ 
  ...
  { 5, 0, 0, {{MB_OFF, 100, 0, 0}, {MB_ON, 50, 0, 0},   {MB_LOOP, 0, LOOP_PARAM(0, 4), 0},  {MB_OFF, 800, 0, 0}, {MB_NULL, 0, 0, 0}}  },
  { 6, 0, 0, {{MB_OFF, 800, 0, 0}, {MB_ON, 50, 0, 0},   {MB_OFF, 100, 0, 0}, {MB_LOOP, 0, LOOP_PARAM(1, 4), 0},  {MB_NULL, 0, 0, 0}}  },
  { 9, 0, 0, {{MB_OFF, 800, 0, 0}, {MB_OFF, 100, 0, 0}, {MB_ON, 50, 0, 0},   {MB_LOOP, 0, LOOP_PARAM(1, 4), 0},  {MB_NULL, 0, 0, 0}}  },
};
ledTable T2[] =
{
  // Aircraft wing tip flashers
  { 3, 0, 0, {{MB_ON, 20, 0, 0},   {MB_OFF, 50, 0, 0},  {MB_LOOP, 0, LOOP_PARAM(0, 3), 0},  {MB_ON, 250, 0, 0},  {MB_OFF, 450, 0, 0}} },
  { 5, 0, 0, {{MB_OFF, 450, 0, 0}, {MB_ON, 20, 0, 0},   {MB_OFF, 50, 0, 0},  {MB_LOOP, 0, LOOP_PARAM(1, 3), 0},  {MB_ON, 250, 0, 0}}  },
  ...
  // Simple fade in/out
  { 9, 0, 0, {{MB_FADE_ON, 10, FADE_PARAM(0, 255), 0}, {MB_ON, 70, 0, 0}, {MB_FADE_OFF, 10, FADE_PARAM(255, 0), 0}, {MB_NULL,0,0,0}, {MB_NULL,0,0,0}} },
};
ledTable T3[] =
{
#define	T_OFF	40
...
#define	T_WAIT	500
	...
	{  3,0,0, {{MB_OFF,(T_OFF*0),0,0}, {MB_ON,T_ON,0,0}, {MB_FADE_OFF,T_FADE,FADE_PARAM(150,0),0}, {MB_OFF,T_WAIT+(T_OFF*5),0,0}, {MB_NULL,0,0,0}} },
	{  5,0,0, {{MB_OFF,(T_OFF*1),0,0}, {MB_ON,T_ON,0,0}, {MB_FADE_OFF,T_FADE,FADE_PARAM(150,0),0}, {MB_OFF,T_WAIT+(T_OFF*4),0,0}, {MB_NULL,0,0,0}} },
	{  6,0,0, {{MB_OFF,(T_OFF*2),0,0}, {MB_ON,T_ON,0,0}, {MB_FADE_OFF,T_FADE,FADE_PARAM(150,0),0}, {MB_OFF,T_WAIT+(T_OFF*3),0,0}, {MB_NULL,0,0,0}} },
	{  9,0,0, {{MB_OFF,(T_OFF*3),0,0}, {MB_ON,T_ON,0,0}, {MB_FADE_OFF,T_FADE,FADE_PARAM(150,0),0}, {MB_OFF,T_WAIT+(T_OFF*2),0,0}, {MB_NULL,0,0,0}} },
